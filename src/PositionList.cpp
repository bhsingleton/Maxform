...
void PositionList::getCacheSetup(const MEvaluationNode& evaluationNode, MNodeCacheDisablingInfo& disablingInfo, MNodeCacheSetupInfo& cacheSetupInfo, MObjectArray& monitoredAttributes) const
/**
...
*/
{
	...
	//
	monitoredAttributes.append(PositionList::position);
	monitoredAttributes.append(PositionList::x_position);
	monitoredAttributes.append(PositionList::y_position);
	monitoredAttributes.append(PositionList::z_position);
