...
void ScaleList::getCacheSetup(const MEvaluationNode& evaluationNode, MNodeCacheDisablingInfo& disablingInfo, MNodeCacheSetupInfo& cacheSetupInfo, MObjectArray& monitoredAttributes) const
/**
...
*/
{
	...
	//
	monitoredAttributes.append(ScaleList::scale);
	monitoredAttributes.append(ScaleList::x_scale);
	monitoredAttributes.append(ScaleList::y_scale);
	monitoredAttributes.append(ScaleList::z_scale);
